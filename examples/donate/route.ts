...
const DONATION_DESTINATION_WALLET =
  'GwcZREtjJBqYyhZ7kv3ecuQVtG55CbNVTJPSXckVq9NR';
const DONATION_AMOUNT_SOL_OPTIONS = [0.01, 0.1, 0.25];
...
> {
  const icon =
    'https://arweave.net/QHC_McGUXnDNs6KMQ0YJ8IHnlzjZyo9XpUAmTt49DcQ?ext=png';
  const title = 'Donate to HouseJapa';
  const description =
